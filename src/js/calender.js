...
function showCalendar(_year,_month,_day,firstDay) {
    ...
    //输出日历表格，这部分因结构而异
    showStr = "<table class='sui-table table-bordered my-table cld-w'><thead>";
    //日历头部
    ...
    //日历星期
    showStr += "<tr class='weekNames'><th>星期日</th><th>星期一</th><th>星期二</th><th>星期三</th><th>星期四</th><th>星期五</th><th>星期六</th></tr>";
...
var calendar = document.getElementById("my-calender");
//日历点击的事件委托
