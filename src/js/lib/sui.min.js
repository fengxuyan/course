!function a(b, c, d) {
    ...
    /*删除日历空行*/
    function deleteCalenderSpace() {
        if($("tr").children(".old").length==7){
            $(".old").parent("tr").remove()

        }else if($("tr").children(".new").length>7){
            $($(".new:last-child").parent("tr"))[1].remove()
        }else if($("tr").children(".new").length==7){
            $(".new").parent("tr").remove()
        }
    }
        ...
        !function (a, b) {
            ...
            j.prototype = {
                constructor: j, _process_options: function (b) {
                    ...
                    this.picker.find(".datepicker-days thead th.datepicker-switch").text(f + "年 " + o[this.o.language].months[g]), this.picker.find("tfoot th.today").text(l).toggle(this.o.todayBtn !== !1), this.picker.find("tfoot th.clear").text(m).toggle(this.o.clearBtn !== !1), this.updateNavArrows(), this.fillMonths(),                        deleteCalenderSpace()
                    ;
